def get_range(input):
    ...
    return {"start": range[1], "end": range[1] + range[2] - 1, "start_corr": range[0]}
    ...
    with open("./input1.txt", "r") as file:
        ...
        for seed in seeds:
            ...
            while i < seed["seed_len"]:
                soil = get_corresponding_index(
                    seed["seed_start"] + i, maps["seed-to-soil"]
                )
                ...
                humid = get_corresponding_index(temp, maps["temperature-to-humidity"])
